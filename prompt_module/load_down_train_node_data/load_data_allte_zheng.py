...
np.save('../node_data/zheng/ceshi_20-shot/all/all_train.npy', trainset)  # 保存文件
np.save('../node_data/zheng/ceshi_20-shot/all/all_val.npy', valset)  # 保存文件
np.save('../node_data/zheng/ceshi_20-shot/all/all_test.npy', testset)  # 保存文件
